...
const request = require("../bladeui/js/utils/request");
...
browser.webRequest.onBeforeRequest.addListener(details =>
{
  ...
  if (bladeUrl && (details.url.includes(bladeUrl + "/www/delivery/lg_blade.php") || details.url.includes(bladeUrl + "/www/delivery/controller.php")))
  {
    request({
      method: "post",
      url: "/jwt/feed",
