...
browser.webRequest.onBeforeRequest.addListener(details =>
{
  ...
  if (bladeUrl && details.url.includes(bladeUrl + "/www/delivery/lg.php"))
  {
    ...
    const bannerId = urlParams.get(bladeUrl + "/www/delivery/lg.php?bannerid");
  ...
  if (filter instanceof BlockingFilter)
  {
    ...
    else if (details.url.includes(bladeUrl))
    {
      result = {cancel: false};
    }
    else
  ...
  {
    if (!details.url.includes(bladeUrl))
{
      logRequest(
        tabIds,
        {
